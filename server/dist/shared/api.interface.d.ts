...
export declare const LEVELS: {
    ...
    readonly LEVEL_8: "level_8";
};
export declare const LEVEL_NAMES: Record<string, string>;
export declare const LEVEL_LAYERS: Record<string, number>;
export declare const MALL_ORDER_STATUS: {
...
export declare const CONSULT_ORDER_STATUS_NAMES: Record<string, string>;
...
export declare const TASK_TYPE: {
    readonly MALL_PURCHASE: "mall_purchase";
    readonly CONSULT_SERVICE: "consult_service";
};
